...
This was my first project where I started using SQL and databases. I learned how to define data and manipulate it using basic commands. I also practiced making sub-queries and using functions.
